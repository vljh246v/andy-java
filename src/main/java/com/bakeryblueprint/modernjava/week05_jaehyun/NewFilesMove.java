...
public class NewFilesMove {
  ...
  public static void moveFile(final Path source, final Path target,
  ...
  public static void main(final String[] args) {
    if (args.length > 2) {
      System.out.println("Usage : java newFileMove <source file> <target file>");
      return;
    }
    ...
    NewFilesMove.moveFile(source, target, options);
  }
}
